...
@lru_cache(None)
def get_device_capability(device: Optional[torch.types.Device] = None) -> dict[str, Any]:
...
def get_device_properties(device: Optional[torch.types.Device] = None) -> _XpuDeviceProperties:
